...
public class UserAddController {
	...
	public String processUserAddForm(@RequestParam("roles") String roles,
			@Validated(UserValidation.class) @ModelAttribute("userAddForm") UserAddForm userForm,
			BindingResult userResult,
			@Validated(AdminValidation.class) @ModelAttribute("adminAddForm") AdminAddForm adminForm,
			BindingResult adminResult,
			Model model) {

		// 管理者の場合は、AdminAddFormを使う
